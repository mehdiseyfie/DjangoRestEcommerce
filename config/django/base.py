...
LOCAL_APPS = [
    'djangorestecommerce.core.apps.CoreConfig',
...
if os.environ.get('GITHUB_WORKFLOW'):
    DATABASES = {
        'default': {
            ...
            'NAME': 'github_actions',
            'USER': 'mehdiseyfi',
            'PASSWORD': '1441mehdi@75t$isFuck921',
            'HOST': '127.0.0.1',
            'PORT': '5432',
        }
    }
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'djangorestecommerce.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'djangorestecommerce.api.exception_handlers.hacksoft_proposed_exception_handler',
