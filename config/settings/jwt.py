...
JWT_AUTH = {
    "JWT_GET_USER_SECRET_KEY": "djangorestecommerce.authentication.services.auth_user_get_jwt_secret_key",
    "JWT_RESPONSE_PAYLOAD_HANDLER": "djangorestecommerce.authentication.services.auth_jwt_response_payload_handler",
